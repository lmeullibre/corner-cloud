...
from .views import launch_game, shutdown_game, check_container_status, remove_game_network
...
urlpatterns = [
    ...
    path('<slug:slug>/remove-network/', remove_game_network, name='remove_game_network'),
